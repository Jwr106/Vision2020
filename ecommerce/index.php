	  ...
	  <div id="myCarousel" class="carousel slide" data-ride="carousel">
	    ...
	    <div class="carousel-inner">
	      <div class="carousel-item active">
	      	<img src="images/slideshow/woman-with-brown-hair-wearing-eyeglasses-1112203.jpg">
	      ...
	      <div class="carousel-item">
	      	<img src="images/slideshow/selective-focus-photography-of-pink-and-black-framed-975668.jpg" >
	        <!-- <svg class="bd-placeholder-img" width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid slice" focusable="false" role="img"><rect width="100%" height="100%" fill="#777"/></svg> -->
	        <div class="container">
	      ...
	      <div class="carousel-item">
	      	<img src="images/slideshow/gray-framed-eyeglasses-on-black-surface-2095953.jpg" >
	        <!-- <svg class="bd-placeholder-img" width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid slice" focusable="false" role="img"><rect width="100%" height="100%" fill="#777"/></svg> -->
	        <div class="container">
	          <div class="carousel-caption text-right">
	            <h1>Get a spectacular look</h1>
	            <p>We have all you need to look spectacular.</p>
	            <p><a class="btn btn-lg btn-primary" href="store.php" role="button">Checkout Our Store</a></p>
	          </div>
	        </div>
	      </div>
	    </div>
